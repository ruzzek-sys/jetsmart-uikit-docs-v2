...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Payment", slug: "payment", desc: "Métodos y formularios de pago.", nodes: ["6567:76337", "6567:77547"], live: true },
      { label: "Progress Bar", slug: "progress-bar", desc: "Barra de progreso.", nodes: ["6065:115112"], live: true },
      { label: "Promo Code", slug: "promo-code", desc: "Ingreso y validación de código promocional.", nodes: ["6065:115139"], live: true },
      { label: "Quantity Stepper", slug: "quantity-stepper", desc: "Control para aumentar o disminuir cantidades.", nodes: ["5356:16037"], live: true },
      ...
      { label: "Sidebar", slug: "sidebar", desc: "Panel lateral de navegación o contenido.", nodes: ["6567:79655"], live: true },
